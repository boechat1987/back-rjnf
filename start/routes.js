...
Route.get('/prog/semana/busca/apontamento/:semana', "ProgramacaoController.showProgWithoutOrdem")
Route.get('/prog/dia/busca/:data', "ProgramacaoController.showProgDoDia")
Route.post('/prog/apontamento/:id', "ProgramacaoController.updateProgApontByDate")
Route.post('/prog/apontlastupload', "ProgramacaoController.updateProgApontByLastUpload")
Route.get('/prog/semana/:id', "ProgramacaoController.show")
Route.get('/prog/apontamento/:id', "ProgramacaoController.showStatusApontamento")
